...
def login():
    ...
    #driver.find_element_by_class_name('div.scanicon-toLogin.js-qrcode-switch').click()
    driver.find_element_by_css_selector("[class='scanicon-toLogin js-qrcode-switch']").click()
    time.sleep(2)
    driver.find_element_by_css_selector("[class='l-stype js-l-stype']").click()
    driver.find_element_by_name("username").clear()
    driver.find_element_by_name("username").send_keys(u"邱淑贞大傻子nac196")
    driver.implicitly_wait(5)
    driver.find_element_by_name("password").clear()
    driver.find_element_by_name("password").send_keys("ypsphbezjd")
    time.sleep(2)
